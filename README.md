...
| 技能 | 说明 | 来源 |
|------|------|------|
| 📄 `pdf` | PDF 文件读取、编辑、生成 | Anthropic 官方 |
| 📝 `docx` | Word 文档处理 | Anthropic 官方 |
| 📊 `pptx` | PowerPoint 演示文稿处理 | Anthropic 官方 |
| 📈 `xlsx` | Excel 电子表格处理 | Anthropic 官方 |
| 🔧 `skill-creator` | 创建和修改技能 | Anthropic 官方 |
| 🔌 `mcp-builder` | MCP 服务器构建指南 | Anthropic 官方 |
| 🌐 `webapp-testing` | Web 应用测试工具包 | Anthropic 官方 |
| 💡 `brainstorming` | 创意头脑风暴 | Superpowers |
| 🐛 `systematic-debugging` | 系统化调试流程 | Superpowers |
| 📋 `writing-plans` | 编写实施计划 | Superpowers |
| ✅ `test-driven-development` | 测试驱动开发 | Superpowers |
| ⚡ `executing-plans` | 执行实施计划 | Superpowers |
| 🔍 `verification-before-completion` | 完成前验证 | Superpowers |
